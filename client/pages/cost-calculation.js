...
import {ErrorOpen, SuccessOpen} from "../hocks/hideShowFeedBack";
...
const CostCalculation = () => {
    ...
    return (
        <section className={'page_calculations'}>
            ...
            <div className={'container'}>
                ...
                <div className={'page_calculations_grid'}>

                    <div className={'page_calculations_child'}>

                        <div className={'flex_space'}>

                            <div style={{marginRight: '30px'}} className={'page_calculations_input'}>
                                <input
                                    type={'name'}
                                    maxLength={30}
                            ...
                            <div className={'page_calculations_input'}>
                                <input
                                    type={'name'}
                                    maxLength={30}
                        ...
                        <div id={'arrow_svg'} className={'arrow_svg'}>

                            <svg id="Слой_1" data-name="Слой 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 219 4">
                                <line className={'str_cls_1'} x1="2" y1="2" x2="216.02" y2="2"/>
                                <polygon className={'str_cls_2'} points="214.61 3.85 215.4 2 214.61 0.15 219 2 214.61 3.85"/>
                                <circle className={'str_cls_2'} cx="2" cy="2" r="2"/>
                            </svg>
                    ...
                    <div className={'page_calculations_child'}>
                        ...
                        <div className={'page_calculations_temperature'}>
                            <h3>
                                Температурный режим *
                            </h3>
                            <div>
                            ...
                            <div
                                ...
                                className={'page_calculations_input_temperature'}
                            >
                                <div style={{textAlign: 'center', marginBottom: '10px', fontSize: '12px'}}>от -20 до +20</div>

                                <div className={'page_calculations_flex'}>
                        ...
                        {/*Тип груза*/}
                        <div className={'change_typeOf_cargo'}>
                            ...
                            <div
                                ...
                                className={'page_calculations_typeOf_cargo'}
                            >
                                <div className={'type_cargo'}>
                                    Продукты питания
                                </div>
                                <div>
                                    <Switch
