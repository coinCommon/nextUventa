...
const DCModals = dynamic(() => import('../components/Admin/modals'));
const DCEditModals = dynamic(() => import('../components/Admin/editModals'));
...
const Admin = () => {
    ...
    useMemo( () => {
        ...
        if (state === 5 || stateData === 5) {setDataTypeName([{name: 'наша команда'}])}
        ...
        if (state !== 0 && typeof window !== 'undefined') {document.body.style.overflow = 'hidden'}
        if (state === 0 && typeof window !== 'undefined') {
    ...
    return (
        <section className={'section_admin'}>
            ...
            <div className={'admin_data'}>
                ...
                <div className={'admin_line_data'}>
                    <h4>
                        uventa-panel v0.1
                    </h4>
                    <div style={{display: 'flex', alignItems: 'center'}}>
                        <button className={'button_message'} onClick={() => setStateData(10)}>
                            Включить снег
                        </button>
                        <button className={'button_message'} onClick={() => setStateData(10)}>
                            Мои сообщения
                ...
                <div className={'admin_grid'}>
                    ...
                    <div className={'child_left'}>
                        ...
                        <div className={'chapter'}>
                            <div onClick={() => HideAndShows(menuServices, setMenuServices)} className={'chapter_flex'}>
                                <div style={menuServices ? {color: 'limegreen'} : {}} className={name}>
                                    Услуги
                                </div>
                                <div style={menuServices ? {transform: 'rotate(180deg)', left: '-10px'} : {}} className={'arrow_4'}>
                        ...
                        <div className={'chapter'}>
                            <div onClick={() => HideAndShows(menuPrices, setMenuPrices)} className={'chapter_flex'}>
                                <div style={menuPrices ? {color: 'limegreen'} : {}} className={'name'}>
                                    Цены
                                </div>
                                <div style={menuPrices ? {transform: 'rotate(180deg)', left: '-10px'} : {}} className={'arrow_4'}>
                                    <span className={'arrow_4_left'}></span>
                                    <span className={'arrow_4_right'}></span>
                                </div>
                            </div>
                        ...
                        <div className={'chapter'}>
                            <div onClick={() => HideAndShows(menuDocumentsChapter, setMenuDocumentsChapter)} className={'chapter_flex'}>
                                <div style={menuDocumentsChapter ? {color: 'limegreen'} : {}} className={'name'}>
                                    Разделы документов
                                </div>
                                <div style={menuDocumentsChapter ? {transform: 'rotate(180deg)', left: '-10px'} : {}} className={'arrow_4'}>
                                    <span className={'arrow_4_left'}></span>
                                    <span className={'arrow_4_right'}></span>
                                </div>
                            </div>
                        ...
                        <div className={'chapter'}>
                            <div onClick={() => HideAndShows(menuDocuments, setMenuDocuments)} className={'chapter_flex'}>
                                <div style={menuDocuments ? {color: 'limegreen'} : {}} className={'name'}>
                                    Документы
                                </div>
                                <div style={menuDocuments ? {transform: 'rotate(180deg)', left: '-10px'} : {}} className={'arrow_4'}>
                                    <span className={'arrow_4_left'}></span>
                                    <span className={'arrow_4_right'}></span>
                                </div>
                            </div>
                        ...
                        <div className={'chapter'}>
                            <div onClick={() => HideAndShows(menuTechnology, setMenuTechnology)} className={'chapter_flex'}>
                                <div  style={menuTechnology ? {color: 'limegreen'} : {}} className={'name'}>
                                    Наша команда
                                </div>
                                <div style={menuTechnology ? {transform: 'rotate(180deg)', left: '-10px'} : {}} className={'arrow_4'}>
                                    <span className={'arrow_4_left'}></span>
                                    <span className={'arrow_4_right'}></span>
                                </div>
                            </div>
                        ...
                        {allStore._isAdmin ?
                        <div className={'chapter'}>
                            <div onClick={() => HideAndShows(menuUsers, setMenuUsers)} className={'chapter_flex'}>
                                <div style={menuUsers ? {color: 'limegreen'} : {}} className={'name'}>
                                    Пользователи
                                </div>
                                <div style={menuUsers ? {transform: 'rotate(180deg)', left: '-10px'} : {}} className={'arrow_4'}>
                                    <span className={'arrow_4_left'}></span>
                                    <span className={'arrow_4_right'}></span>
                                </div>
                            </div>
                        ...
                        <div className={'chapter'}>
                            <div onClick={() => HideAndShows(menuSlides, setMenuSlides)} className={'chapter_flex'}>
                                <div style={menuSlides ? {color: 'limegreen'} : {}} className={'name'}>
                                    Слайдер
                                </div>
                                <div style={menuSlides ? {transform: 'rotate(180deg)', left: '-10px'} : {}} className={'arrow_4'}>
                                    <span className={'arrow_4_left'}></span>
                                    <span className={'arrow_4_right'}></span>
                                </div>
                            </div>
                        ...
                        <div className={'chapter'}>
                            <div onClick={() => HideAndShows(menuNews, setMenuNews)} className={'chapter_flex'}>
                                <div style={menuNews ? {color: 'limegreen'} : {}} className={'name'}>
                                    Новости
                                </div>
                                <div style={menuNews ? {transform: 'rotate(180deg)', left: '-10px'} : {}} className={'arrow_4'}>
                                    <span className={'arrow_4_left'}></span>
                                    <span className={'arrow_4_right'}></span>
                                </div>
                            </div>
                        ...
                        <div className={'chapter'}>
                            <div onClick={() => HideAndShows(menuToken, setMenuToken)} className={'chapter_flex'}>
                                <div style={menuToken ? {color: 'limegreen'} : {}} className={name}>
                                    TOKEN (Для опытных пользователей)
                                </div>
                                <div style={menuToken ? {transform: 'rotate(180deg)', left: '-10px'} : {}} className={'arrow_4'}>
                                    <span className={'arrow_4_left'}></span>
                                    <span className={'arrow_4_right'}></span>
                                </div>
                            </div>
