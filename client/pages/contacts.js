            ...
            <div className={'container'}>
                ...
                <div className={'contacts_grid'}>
                    ...
                    <div className={'child'}>
                        ...
                        <div className={'messengers_icons'}>
                            <div onClick={() => window.open('https://t.me/+79603368800')} className={'messenger_icon'}>
                            ...
                            <div onClick={() => window.open('https://wa.me/79603368800?text=%D0%97%D0%B4%D1%80%D0%B0%D0%B2%D1%81%D1%82%D0%B2%D1%83%D0%B9%D1%82%D0%B5!')} className={'messenger_icon'}>
                    ...
                    <div className={'child'}>
                        ...
                        <div style={{marginBottom: '5px'}} className={'text'}>
                            ПН-ПТ 08:30-17:30
                        </div>
                        <div className={'text'}>
                    ...
                    <div className={'child'}>
                        <button onClick={() => window.open('https://yandex.ru/profile/-/CCU0V6VBCC')} className={'button_black'}>Проложить маршрут</button>
                    </div>
